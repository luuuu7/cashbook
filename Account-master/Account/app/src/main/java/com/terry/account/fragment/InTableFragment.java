 ...
 *
 */
public class InTableFragment extends Fragment {
...
//	private static final String TAG = AboutFragment.class.getSimpleName();
	...
	private static InTableFragment instance;

	public static InTableFragment getInstance() {
		if (instance == null) instance = new InTableFragment();
		return instance;
	}
