...
/**
 * Manages beeps and vibrations for  管理声音和震动
 */
public final class BeepManager implements MediaPlayer.OnCompletionListener,
	...
	public synchronized void updatePrefs() {
		...
		vibrate = prefs.getBoolean(com.terry.account.zxing.android.PreferencesActivity.KEY_VIBRATE, false);
	...
	private static boolean shouldBeep(SharedPreferences prefs, Context activity) {
		boolean shouldPlayBeep = prefs.getBoolean(
				com.terry.account.zxing.android.PreferencesActivity.KEY_PLAY_BEEP, true);
		if (shouldPlayBeep) {
